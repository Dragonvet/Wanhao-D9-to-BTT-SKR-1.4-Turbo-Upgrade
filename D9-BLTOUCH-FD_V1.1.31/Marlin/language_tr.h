...
#define MSG_SD_INSERTED                     _UxGT("SD Yerleşti.")                                       
#define MSG_SD_REMOVED                      _UxGT("SD Çıkarıldı.")                                      
#define MSG_LCD_ENDSTOPS                    _UxGT("Endstops") 
#define MSG_MAIN                            _UxGT("Ana")                                                
#define MSG_BACK                            _UxGT("Geri")                                               
#define MSG_AUTOSTART                       _UxGT("Otobaşlat")                                          
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Sıradaki Nokta")                                     
#define MSG_LEVEL_BED_DONE                  _UxGT("Seviyeleme Tamam!")                                  
...
#define MSG_PREHEAT_1                       _UxGT("Ön Isınma PLA")                                      
#define MSG_PREHEAT_1_N                     MSG_PREHEAT_1 _UxGT(" ")                                    
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1 _UxGT(" Tüm")                                 
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1 _UxGT(" Nozül")                               
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1 _UxGT(" Tabla")                               
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1 _UxGT(" Ayar")                                
#define MSG_PREHEAT_2                       _UxGT("Ön Isınma ABS")                                      
#define MSG_PREHEAT_2_N                     MSG_PREHEAT_2 _UxGT(" ")                                    
#define MSG_PREHEAT_2_ALL                   MSG_PREHEAT_2 _UxGT(" Tüm")                                 
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2 _UxGT(" Nozül")                               
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2 _UxGT(" Tabla")                               
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2 _UxGT(" Ayar")                                
...
#define MSG_MOVE_AXIS                       _UxGT("Eksen Yönet")                                        
#define MSG_BED_LEVELING                    _UxGT("Tabla Seviyele")                                     
#define MSG_LEVEL_BED                       _UxGT("Tabla Seviyele")                                     
#define MSG_MOVING                          _UxGT("Konumlanıyor...")                                    
...
#define MSG_FILAMENT_DIAM                   _UxGT("Fil. Çap")                                           
...
#define MSG_CNG_SDCARD                      _UxGT("SD Değiştir")                                        
...
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("Hata: Geçersiz Sıcaklık")                            
#define MSG_THERMAL_RUNAWAY                 _UxGT("TERMAL PROBLEM")                                     
#define MSG_ERR_MAXTEMP                     _UxGT("Hata: MAXSICAKLIK")                                  
#define MSG_ERR_MINTEMP                     _UxGT("Hata: MINSICAKLIK")                                  
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Hata: MAXSIC. TABLA")                                
#define MSG_ERR_MINTEMP_BED                 _UxGT("Hata: MINSIC. TABLA")                                
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z Yapılamaz")                                    
#define MSG_HALTED                          _UxGT("YAZICI DURDURULDU")                                  
#define MSG_PLEASE_RESET                    _UxGT("Lütfen resetleyin")                                  
#define MSG_SHORT_DAY                       _UxGT("G") 
#define MSG_SHORT_HOUR                      _UxGT("S") 
#define MSG_SHORT_MINUTE                    _UxGT("D") 
#define MSG_HEATING                         _UxGT("Isınıyor...")                                        
#define MSG_HEATING_COMPLETE                _UxGT("Isınma tamam.")                                      
#define MSG_BED_HEATING                     _UxGT("Tabla Isınıyor.")                                    
#define MSG_BED_DONE                        _UxGT("Tabla hazır.")                                       
...
#define MSG_INFO_BOARD_MENU                 _UxGT("Kontrolör Bilgisi")                                  
...
#define MSG_CASE_LIGHT                      _UxGT("Aydınlatmayı")                                       
#if LCD_WIDTH >= 20
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Daha Akıt")                                          
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Baskıyı sürdür")                                     
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Min. Sıcaklık")                                      
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Nozül: ")                                          
#if LCD_HEIGHT >= 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Başlama bekleniyor")                               
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("filamanın")                                        
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("değişimi")                                         
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Bekleniyor")                                       
  ...
  #define MSG_FILAMENT_CHANGE_HEAT_1          _UxGT("Nozülü Isıtmak için")                              
  #define MSG_FILAMENT_CHANGE_HEAT_2          _UxGT("Butona Bas.")                                      
  #define MSG_FILAMENT_CHANGE_HEATING_1       _UxGT("Nozül Isınıyor")                                   
  #define MSG_FILAMENT_CHANGE_HEATING_2       _UxGT("Lütfen Bekleyin...")                               
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Bekleniyor")                                       
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filamanın yüklenmesi")                             
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Bekleniyor")                                       
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("filaman akması")                                   
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Akıtılıyor...")                                    
